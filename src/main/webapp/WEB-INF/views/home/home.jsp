	...
	<div class="container my-5 w-50">
			...
			<c:forEach var="course" items="${courses}">
				<div class="px-4 py-3 rounded mb-3 bg-blue50">
					...
					<div class="d-flex">
						...
						<input class="btn btn-primary" type="button" value="Start Learning" onclick="location.href='${context}course/${course.courseId}'">
					</div>
		...
		<div>
			...
			<c:forEach var="news" items="${newses}">
				<div class="card mb-3 border-0 px-1 bg-blue50" style="cursor: pointer;" onclick="location.href='${context}course/${news.courseId}/news/${news.newsId}'">
					<div class="card-body">
