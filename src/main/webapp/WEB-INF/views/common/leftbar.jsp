...
<div class="d-flex flex-column flex-shrink-0 position-fixed top-0 start-0 vh-100 w-25 bg-blue50" style="max-width:280px;" id="leftbarContainer">
    <a href="/studybite/home" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
      <img class="w-100 px-5 py-3" src="${resPath}/img/logoSmall.png" alt="studybite">
    </a>
   <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="/studybite/home" class="nav-link white600">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#home"/></svg>
          대시보드
        </a>
      </li>
      <li class="nav-item">
        <a href="/studybite/course" class="nav-link white600">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#speedometer2"/></svg>
          수강과목
        </a>
      </li>
      <li class="nav-item">
        <a href="/studybite/mypage" class="nav-link white600">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#table"/></svg>
          내 정보
        </a>
      </li>
      <li class="nav-item">
        <a href="/studybite/notice" class="nav-link white600">
