...
<ul class="nav col-12 col-md-auto mb-2 justify-content-left mb-md-0 mt-5">
	...
	<%--          <li><a href="/studybite/course/${courseInfo.courseId}" class="courseBar nav-link px-2 link-secondary"><img id="image" src="/studybite/resources/img/courseIcon/iattendance.png" class="img me-2" width="15" height="15">출결 현황</a></li> --%>
</ul>