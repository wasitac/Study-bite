			...
			<table class="table table-hover" style="width: 1000px">
				...
				<tbody class="table-group-divider">
					...
					<tr class="table-primary">
						<td><a href="/studybite/course/news/newsDesc">예시 1</a></td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
					...
					<tr class="table-primary">
						<td><a href="/studybite/course/news/newsDesc">예시 2</a></td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
					...
					<tr class="table-primary">
						<td><a href="/studybite/course/news/newsDesc">예시 3</a></td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
