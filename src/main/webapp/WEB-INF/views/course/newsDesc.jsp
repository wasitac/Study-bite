				...
				<%@ include file="../common/courseBar.jsp" %>
					<div class="my-1 text-left">
						<h3 class="blue600 info">
							<button class="btn border-0" type="submit"
								onclick="location.href='/studybite/course/${news.courseId}/news'" style="background-color: white">
					...
					<form:form modelAttribute="news" method="delete" id="deleteForm">
						...
						<c:if test="${not empty fileBoard}">
							...
							<a href="${context}course/news/${newsId}/filedown?fileName=${fileBoard.originName}">파일 다운로드</a>
						</c:if>
		...
		<script type="text/javascript">
			...
			$(".delete").click(
				function () {
					...
					//확인창에서 확인을 클릭하면,
					if (choice) {
						$('#deleteForm').attr('action', '/studybite/course/' + courseId + '/news/' + id).submit();
					}
				});
		</script>
	</body>
