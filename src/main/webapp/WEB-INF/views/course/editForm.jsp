					...
					<div class="contatiner">
						<form:form modelAttribute="select" action="${context}course/${courseId}/qna/${qnaId}" method="post"
							...
							<div class="row">
								...
								<form:input path="title" class="form-control mt-1 mb-2 col" value="${title}" placeholder="제목을 입력해주세요.(100자 이내)" required="true" />
							...
							<div class="form-group row">
								...
								<form:textarea path="description" class="description form-control col" rows="10"  maxlength="1000" 
									placeholder="내용을 입력해주세요.(1000자 이내)" required="true" value="${description}" />
